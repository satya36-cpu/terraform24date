...
class AddLead extends Cart
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $leadToken = $request->getPost('leadToken');
        ...
        if (!$this->_formKeyValidator->validate($request)) {
            ...
            $this->logger->error('Invalid form key. Warranty data: ' .
        ...
        try {
            ...
            $warrantyData['leadToken'] = $leadToken;
